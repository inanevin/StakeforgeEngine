...
static constexpr std::string_view basic_charset{"!#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[]^_`abcdefghijklmnopqrstuvwxyz{|}~"};
...
template <> struct glz::meta<another_object_t>
{
	...
	static constexpr auto value = object(&T::string, &T::another_string, &T::escaped_text, &T::boolean, &T::nested_object);
};
#endif
...
{
	using T						= obj_t;
	static constexpr auto value = object(&T::fixed_object, &T::fixed_name_object, &T::another_object, &T::string_array, &T::string, &T::number, &T::boolean, &T::another_bool);
};
#endif
...
template <auto Opts> auto glaze_test()
{
...
template <class T> struct test_generator
{
	...
	template <class V> V randomizeNumberUniform(V range)
	{
...
{
	using T							 = test_struct;
	static constexpr auto parseValue = object(&T::testStrings, &T::testUints, &T::testDoubles, &T::testInts, &T::testBools);
};

template <class value_type> struct abc_test
{
...
template <> struct glz::meta<abc_test<test_struct>>
{
	...
	static constexpr auto value = glz::object(&T::a, &T::b, &T::c, &T::d, &T::e, &T::f, &T::g, &T::h, &T::i, &T::j, &T::k, &T::l, &T::m, &T::n, &T::o, &T::p, &T::q, &T::r, &T::s, &T::t, &T::u, &T::v, &T::w, &T::x, &T::y, &T::z);
};

template <auto Opts> auto benchmark_tester()
{
	std::string					buffer{};
...
template <> struct glz::meta<channel_data>
{
	...
	static constexpr auto value = object("permission_overwrites",
										 &T::permission_overwrites,
										 "last_message_id",
										 &T::last_message_id,
										 "default_thread_rate_limit_per_user",
										 &T::default_thread_rate_limit_per_user,
										 "applied_tags",
										 &T::applied_tags,
										 "recipients",
										 &T::recipients,
										 "default_auto_archive_duration",
										 &T::default_auto_archive_duration,
										 "status",
										 &T::status,
										 "last_pin_timestamp",
										 ...
										 &T::topic,
										 "rate_limit_per_user",
										 &T::rate_limit_per_user,
										 "icon_emoji",
										 &T::icon_emoji,
										 "total_message_sent",
										 &T::total_message_sent,
										 "video_quality_mode",
										 &T::video_quality_mode,
										 "application_id",
										 &T::application_id,
										 "permissions",
										 &T::permissions,
...
{
	using T						= user_data;
	static constexpr auto value = object("avatar_decoration_data",
										 &T::avatar_decoration_data,
										 "display_name",
										 &T::display_name,
										 "global_name",
										 &T::global_name,
...
{
	using T						= member_data;
	static constexpr auto value = object("communication_disabled_until",
										 &T::communication_disabled_until,
										 "premium_since",
										 &T::premium_since,
										 "nick",
										 &T::nick,
...
{
	using T						= role_data;
	static constexpr auto value = object("unicode_emoji",
										 &T::unicode_emoji,
										 "icon",
										 &T::icon,
										 "permissions",
...
{
	using T						= guild_data;
	static constexpr auto value = object("latest_on_boarding_question_id",
										 &T::latest_on_boarding_question_id,
										 "guild_scheduled_events",
										 &T::guild_scheduled_events,
										 "safety_alerts_channel_id",
										 &T::safety_alerts_channel_id,
										 "inventory_settings",
										 ...
										 &T::default_message_notifications,
										 "max_stage_video_channel_users",
										 &T::max_stage_video_channel_users,
										 "public_updates_channel_id",
										 &T::public_updates_channel_id,
										 "description",
										 &T::description,
										 "threads",
										 &T::threads,
										 ...
										 &T::premium_progress_bar_enabled,
										 "members",
										 &T::members,
										 "hub_type",
										 &T::hub_type,
...
template <class T, auto Opts> auto generic_tester()
{
	T obj{};
