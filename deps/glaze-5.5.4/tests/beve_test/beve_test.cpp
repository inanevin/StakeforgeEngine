...
template <> struct glz::meta<sub_thing2>
{
	...
	static constexpr auto			  value = object("include",
										 glz::file_include{}, //
										 "a",
										 &T::a, //
										 "b",
...
template <> struct glz::meta<some_struct>
{
...
void test_partial()
{
	expect(glz::name_v<glz::detail::member_tuple_t<some_struct>> == R"(glz::tuple<int32_t,double,Color,std::string,std::array<uint64_t,3>,sub,std::map<std::string,int32_t>>)");
...
template <> struct glz::meta<includer_struct>
{
...
template <> struct glz::meta<falcon0>
{
	using T						= falcon0;
...
template <> struct glz::meta<falcon1>
{
	using T						= falcon1;
...
template <> struct glz::meta<skipper>
{
	using T						= skipper;
...
namespace variants
{
	...
	suite variants = [] {
		"variants"_test = [] {
			...
			D					 d{};
			expect(not glz::write<glz::opts{.format = glz::BEVE, .structs_as_arrays = true}>(d, out)); // testing compilation
		};
	};
}
...
template <> struct glz::meta<Header>
{
...
suite past_fuzzing_issues = [] {
	"fuzz0"_test = [] {
		std::string_view base64 = "AwQEaWH//////////////////////////////////////////////////////////////////////////////////////////////////////"
								  "////////////////////////////////////////////////////////////8A=";
	...
	"fuzz3"_test = [] {
		std::string_view base64 = "AzoxKOUMYXJydCQkKOUMYXJydCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJ"
								  "CQkJCQkJCQkJCQkJCkA";
		const auto		 input	= glz::read_base64(base64);
		expect(glz::read_beve<my_struct>(input).error());
	};
	...
	"fuzz8"_test = [] {
		std::string_view base64 = "ERYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYAFgAAAgAWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYAFgIAABYWFhYWFhYWFhYWF"
	...
	"fuzz16"_test = [] {
		std::string_view base64 = "YAVNTU1NTU1NTU1NTU1NTU1NTUlNTTU1NTU1NTU1NTU1NTU1NTU1NTU1NTU1NTU1NTU1NTU1NTU1"
