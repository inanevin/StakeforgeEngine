...
template <> struct glz::meta<inline_table_member>
{
...
template <> struct glz::meta<struct_with_inline_table>
{
...
template <> struct glz::meta<complex_strings_struct>
{
	using T						= complex_strings_struct;
	static constexpr auto value = object("basic_multiline", &T::basic_multiline, "literal_multiline", &T::literal_multiline, "literal_multiline_with_quotes", &T::literal_multiline_with_quotes);
};
...
template <> struct glz::meta<comment_test_struct>
{
...
template <> struct glz::meta<non_null_term_struct>
{
