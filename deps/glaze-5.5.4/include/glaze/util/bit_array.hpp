...
namespace glz
{
	...
	template <size_t N, std::unsigned_integral Chunk = uint64_t> struct bit_array
	{
		...
		constexpr bool operator==(const bit_array& rhs) const noexcept
		{
