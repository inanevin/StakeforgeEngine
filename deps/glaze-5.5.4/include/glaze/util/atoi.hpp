...
namespace glz
{
	inline constexpr std::array<uint64_t, 20> powers_of_ten_int{
	...
	template <std::integral T, class Char> GLZ_ALWAYS_INLINE constexpr bool atoi(T& v, const Char*& it, const Char* end) noexcept
	{
