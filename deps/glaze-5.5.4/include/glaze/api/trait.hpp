...
#undef std_trait
		...
		static constexpr sv to_hash = join_v<type_name_hash,
	...
	namespace detail
	{
		template <std::unsigned_integral T, size_t N> constexpr std::array<T, N> uint_array_from_sv(sv str)
		{
			std::array<T, N> res{};
	...
	template <class T> consteval hash_t hash()
	{
