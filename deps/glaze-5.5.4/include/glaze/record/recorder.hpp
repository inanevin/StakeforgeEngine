...
namespace glz
{
	namespace detail
	{
		template <class Data> struct recorder_assigner
		{
			Data& data;
			sv	  name{};

			template <class T> void operator=(T& ref)
			{
	...
	/// </summary>
	template <class... Ts> struct recorder
	{
	...
	template <is_recorder T> struct to<JSON, T>
	{
	...
	template <is_recorder T> struct from<JSON, T>
	{
	...
	template <is_recorder T> struct to<CSV, T>
	{
