...
namespace glz
{
	...
	template <class T, class Member, class From, class To> struct manage_t
	{
	...
	template <class T, class Member, class From, class To> manage_t(T&, Member, From, To) -> manage_t<T, Member, From, To>;
	...
	template <auto Member, auto From, auto To> inline constexpr decltype(auto) manage_impl()
	{
		return [](auto&& v) { return manage_t{v, Member, From, To}; };
	}

	template <auto Member, auto From, auto To> constexpr auto manage = manage_impl<Member, From, To>();
}
