...
#define GLZ_NULL_TERMINATED true
	...
	enum struct opts_internal : uint32_t
	{
		...
		disable_write_unknown = 1 << 4, // whether to turn off writing unknown fields for a glz::meta specialized for unknown writing
	...
	consteval bool check_opening_handled(auto&& o)
	{
		return o.internal & uint32_t(opts_internal::opening_handled);
	}

	consteval bool check_closing_handled(auto&& o)
	{
		return o.internal & uint32_t(opts_internal::closing_handled);
	}

	consteval bool check_ws_handled(auto&& o)
	{
		return o.internal & uint32_t(opts_internal::ws_handled);
	}

	consteval bool check_no_header(auto&& o)
	{
		return o.internal & uint32_t(opts_internal::no_header);
	}
	...
	consteval bool check_is_padded(auto&& o)
	{
		return o.internal & uint32_t(opts_internal::is_padded);
	}
	...
	consteval bool check_write_unchecked(auto&& o)
	{
		return o.internal & uint32_t(opts_internal::write_unchecked);
	}

	template <auto Opts> constexpr auto opening_handled()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto opening_and_closing_handled()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto opening_handled_off()
	{
		auto ret = Opts;
		ret.internal &= ~uint32_t(opts_internal::opening_handled);
		return ret;
	...
	template <auto Opts> constexpr auto opening_and_closing_handled_off()
	{
		auto ret = Opts;
		ret.internal &= ~(uint32_t(opts_internal::opening_handled) | uint32_t(opts_internal::closing_handled));
		return ret;
	...
	template <auto Opts> constexpr auto ws_handled()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto ws_handled_off()
	{
		auto ret = Opts;
		ret.internal &= ~uint32_t(opts_internal::ws_handled);
		return ret;
	...
	template <auto Opts> constexpr auto no_header_on()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto no_header_off()
	{
		auto ret = Opts;
		ret.internal &= ~uint32_t(opts_internal::no_header);
		return ret;
	...
	template <auto Opts> constexpr auto is_padded_on()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto is_padded_off()
	{
		auto ret = Opts;
		ret.internal &= ~uint32_t(opts_internal::is_padded);
		return ret;
	...
	template <auto Opts> constexpr auto disable_padding_on()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto disable_padding_off()
	{
		auto ret = Opts;
		ret.internal &= ~uint32_t(opts_internal::disable_padding);
		return ret;
	...
	template <auto Opts> constexpr auto write_unchecked_on()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto write_unchecked_off()
	{
		auto ret = Opts;
		ret.internal &= ~uint32_t(opts_internal::write_unchecked);
		return ret;
	...
	template <auto Opts, auto member_ptr> constexpr auto set_opt(auto&& value)
	{
		auto ret		= Opts;
	...
	template <auto Opts, auto member_ptr> constexpr auto opt_on()
	{
		auto ret		= Opts;
		ret.*member_ptr = true;
		return ret;
	...
	template <auto Opts, auto member_ptr> inline constexpr auto opt_true = opt_on<Opts, member_ptr>();

	template <auto Opts, auto member_ptr> constexpr auto opt_off()
	{
		auto ret		= Opts;
	...
	template <auto Opts, auto member_ptr> inline constexpr auto opt_false = opt_off<Opts, member_ptr>();

	template <auto Opts> constexpr auto disable_write_unknown_off()
	{
		auto ret = Opts;
	...
	template <auto Opts> constexpr auto disable_write_unknown_on()
	{
		auto ret = Opts;
		ret.internal |= uint32_t(opts_internal::disable_write_unknown);
		return ret;
	...
	template <auto Opts> constexpr auto set_beve()
	{
		auto ret   = Opts;
		ret.format = BEVE;
		return ret;
	...
	template <auto Opts> constexpr auto set_json()
	{
		auto ret   = Opts;
		ret.format = JSON;
		return ret;
	...
	template <auto Opts> constexpr auto set_toml()
	{
		auto ret   = Opts;
		ret.format = TOML;
		return ret;
...
namespace glz
{
	template <uint32_t Format = INVALID, class T = void> struct to;

	template <uint32_t Format = INVALID, class T = void> struct from;

	template <uint32_t Format = INVALID, class T = void> struct to_partial;

	template <uint32_t Format = INVALID> struct skip_value;
	...
	template <uint32_t Format> struct parse
	{
	};

	template <uint32_t Format> struct serialize
	{
	};

	template <uint32_t Format> struct serialize_partial
	{
	};
}
