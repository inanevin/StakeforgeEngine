...
namespace glz
{
	...
	template <auto Opts, class T, class B> [[nodiscard]] error_ctx read_as(T&& root_value, const sv json_ptr, B&& buffer)
	{
		error_ctx pe{};
	...
	template <auto Opts, class T, class B> [[nodiscard]] bool write_as(T&& root_value, const sv json_ptr, B&& buffer)
	{
		return seek(
			[&](auto&& val) {
