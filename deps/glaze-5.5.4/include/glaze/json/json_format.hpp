...
namespace glz::detail
{
	...
	template <bool use_tabs, uint8_t indentation_width> inline void append_new_line(auto&& b, auto&& ix, const int64_t indent)
	{
		dump<'\n'>(b, ix);
	...
	template <bool null_terminated> GLZ_ALWAYS_INLINE sv read_json_number(auto&& it, auto&& end) noexcept
	{
		auto start = it;
