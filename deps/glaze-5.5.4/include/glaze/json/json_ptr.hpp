...
namespace glz
{
	...
	template <string_literal JsonPointer, auto Opts = opts{}> [[nodiscard]] inline auto get_view_json(contiguous auto&& buffer)
	{
	...
	template <class T, string_literal Str, auto Opts = opts{}> [[nodiscard]] inline expected<T, error_ctx> get_as_json(contiguous auto&& buffer)
	{
	...
	template <string_literal Str, auto Opts = opts{}> [[nodiscard]] inline expected<sv, error_ctx> get_sv_json(contiguous auto&& buffer)
	{
	...
	template <string_literal Path, auto Opts = opts{}> [[nodiscard]] inline error_ctx write_at(const std::string_view value, contiguous auto&& buffer)
	{
