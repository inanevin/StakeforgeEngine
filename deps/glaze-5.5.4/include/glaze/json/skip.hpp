...
namespace glz
{
	template <> struct skip_value<JSON>
	{
		template <auto Opts>
	...
	template <auto Opts> void skip_object(is_context auto&& ctx, auto&& it, auto&& end) noexcept
	{
	...
	template <auto Opts> GLZ_ALWAYS_INLINE auto parse_value(is_context auto&& ctx, auto&& it, auto&& end) noexcept
	{
		auto start = it;
