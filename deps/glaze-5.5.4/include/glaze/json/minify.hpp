...
namespace glz
{
	namespace detail
	{
		...
		template <auto Opts> inline void minify_json(is_context auto&& ctx, auto&& it, auto&& end, auto&& b, auto&& ix) noexcept
		{
	...
	template <auto Opts = opts{}> inline void minify_json(resizable auto& in, auto& out)
	{
		context ctx{};
		detail::minify_json<Opts>(ctx, in, out);
	}

	template <auto Opts = opts{}> inline std::string minify_json(resizable auto& in)
	{
		context		ctx{};
		std::string out{};
		detail::minify_json<Opts>(ctx, in, out);
	...
	template <auto Opts = opts{}> inline void minify_jsonc(const auto& in, auto& out)
	{
		context ctx{};
		detail::minify_json<opt_true<Opts, &opts::comments>>(ctx, in, out);
	}

	template <auto Opts = opts{}> inline std::string minify_jsonc(resizable auto& in)
	{
		context		ctx{};
		std::string out{};
		detail::minify_json<opt_true<Opts, &opts::comments>>(ctx, in, out);
