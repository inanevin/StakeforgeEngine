...
namespace glz::ex
{
	template <class T, auto Opts = opts{}, class Buffer> void write_json_schema(Buffer&& buffer)
	{
	...
	template <class T, auto Opts = opts{}> [[nodiscard]] std::string write_json_schema()
	{
		std::string buffer{};
