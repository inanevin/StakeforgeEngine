...
namespace glz::ex
{
	template <class Buffer> void validate_json(Buffer&& buffer)
	{
	...
	template <class Buffer> void validate_jsonc(Buffer&& buffer)
	{
	...
	template <class T, class Buffer> void read_json(T& value, Buffer&& buffer)
	{
	...
	template <class T, class Buffer> [[nodiscard]] T read_json(Buffer&& buffer)
	{
	...
	template <class T, class Buffer> void read_jsonc(T& value, Buffer&& buffer)
	{
	...
	template <class T, class Buffer> [[nodiscard]] T read_jsonc(Buffer&& buffer)
	{
	...
	template <auto Opts = opts{}, class T> void read_file_json(T& value, const sv file_name, auto&& buffer)
	{
	...
	template <auto Opts = opts{}, class T> void read_file_jsonc(T& value, const sv file_name, auto&& buffer)
	{
	...
	template <class T, class Buffer> void read_ndjson(T& value, Buffer&& buffer)
	{
	...
	template <class T, class Buffer> [[nodiscard]] T read_ndjson(Buffer&& buffer)
	{
	...
	template <auto Opts = opts{}, class T> void read_file_ndjson(T& value, const sv file_name, auto&& buffer)
	{
...
namespace glz::ex
{
	template <class T, class Buffer> void write_json(T&& value, Buffer&& buffer)
	{
	...
	template <class T> [[nodiscard]] auto write_json(T&& value)
	{
	...
	template <class T, class Buffer> void write_jsonc(T&& value, Buffer&& buffer)
	{
		glz::write_jsonc(std::forward<T>(value), std::forward<Buffer>(buffer));
	}

	template <class T> [[nodiscard]] auto write_jsonc(T&& value)
	{
		return glz::write_jsonc(std::forward<T>(value));
	}

	template <auto Opts = opts{}, class T> void write_file_json(T&& value, const sv file_name, auto&& buffer)
	{
	...
	template <class T, class Buffer> void write_ndjson(T&& value, Buffer&& buffer)
	{
		glz::write_ndjson(std::forward<T>(value), std::forward<Buffer>(buffer));
	}

	template <class T> [[nodiscard]] auto write_ndjson(T&& value)
	{
		return glz::write_ndjson(std::forward<T>(value));
	}

	template <class T> void write_file_ndjson(T&& value, const std::string& file_name, auto&& buffer)
	{
