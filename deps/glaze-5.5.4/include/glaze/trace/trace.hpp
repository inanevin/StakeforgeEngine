...
namespace glz
{
	...
	template <> struct meta<display_time_unit>
	{
		static constexpr sv name = "glz::display_time_unit";
		using enum display_time_unit;
		static constexpr auto value = enumerate("s",
												s, //
												"ms",
												ms, //
												"us",
	...
	template <bool Enabled = true> struct trace
	{
