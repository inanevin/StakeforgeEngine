...
namespace glz
{
	...
	[[nodiscard]] inline error_ctx directory_to_buffers(auto& files, const sv directory_path, const sv target_extension = ".json")
	{
	...
	template <auto Opts = opts{}, readable_map_t T> [[nodiscard]] error_ctx read_directory(T& value, const sv directory_path, const sv target_extension = ".json")
	{
