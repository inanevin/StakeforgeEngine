...
namespace taylorCos
{
	...
	template <length_t L, typename T, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> taylorSeriesNewCos(glm::vec<L, T, Q> const& x)
	{
	...
	template <length_t L, typename T, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> taylorSeriesNewCos6(glm::vec<L, T, Q> const& x)
	{
		glm::vec<L, T, Q> const Powed2(x * x);
		glm::vec<L, T, Q> const Powed4(Powed2 * Powed2);
		glm::vec<L, T, Q> const Powed6(Powed4 * Powed2);
	...
	template <glm::length_t L, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, float, Q> fastAbs(glm::vec<L, float, Q> x)
	{
	...
	template <glm::length_t L, typename T, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> fastCosNew(glm::vec<L, T, Q> const& x)
	{
	...
	template <length_t L, typename T, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> deterministic_fmod(glm::vec<L, T, Q> const& x, T y)
	{
		return x - y * trunc(x / y);
	}

	template <length_t L, typename T, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> fastCosDeterminisctic(glm::vec<L, T, Q> const& x)
	{
	...
	template <length_t L, typename T, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> taylorSeriesRefCos(glm::vec<L, T, Q> const& x)
	{
		return static_cast<T>(1) - (x * x) / glm::factorial(static_cast<T>(2)) + (x * x * x * x) / glm::factorial(static_cast<T>(4)) - (x * x * x * x * x * x) / glm::factorial(static_cast<T>(6)) +
			   (x * x * x * x * x * x * x * x) / glm::factorial(static_cast<T>(8));
	}

	template <length_t L, typename T, qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> fastRefCos(glm::vec<L, T, Q> const& x)
	{
...
namespace taylor2
{
	...
	{
		return 1.f - (x * x) * (1.f / 2.f) + (x * x * x * x) * (1.f / 24.f) - (x * x * x * x * x * x) * (1.f / 720.f) + (x * x * x * x * x * x * x * x) * (1.f / 40320.f);
	}
