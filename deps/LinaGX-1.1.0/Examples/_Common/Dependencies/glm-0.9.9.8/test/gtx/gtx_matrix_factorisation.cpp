...
template <glm::length_t C, glm::length_t R, typename T, glm::qualifier Q> int test_qr(glm::mat<C, R, T, Q> m)
{
	int Error = 0;
...
template <glm::length_t C, glm::length_t R, typename T, glm::qualifier Q> int test_rq(glm::mat<C, R, T, Q> m)
{
	int Error = 0;
