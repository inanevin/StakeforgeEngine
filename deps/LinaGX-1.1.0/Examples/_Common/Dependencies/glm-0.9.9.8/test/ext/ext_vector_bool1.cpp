...
template <typename genType> static int test_operators()
{
	int Error = 0;
...
template <typename genType> static int test_ctor()
{
	int Error = 0;
...
template <typename genType> static int test_size()
{
	int Error = 0;
...
template <typename genType> static int test_relational()
{
	int Error = 0;
...
template <typename genType> static int test_constexpr()
{
