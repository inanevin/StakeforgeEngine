...
namespace isPowerOfTwo
{
	...
	template <glm::length_t L> int test_int16()
	{
	...
	template <glm::length_t L> int test_uint16()
	{
	...
	template <glm::length_t L> int test_int32()
	{
	...
	template <glm::length_t L> int test_uint32()
	{
...
{
	template <glm::length_t L, typename T> int run()
	{
		int Error = 0;
