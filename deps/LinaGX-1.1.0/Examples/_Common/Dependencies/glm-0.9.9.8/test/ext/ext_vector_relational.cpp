...
template <typename vecType> static int test_equal()
{
...
template <typename vecType> static int test_notEqual()
{
	typedef typename vecType::value_type valType;
...
template <typename genType, typename valType> static int test_constexpr()
{
...
template <typename T> static int test_equal_ulps()
{
...
template <typename T> static int test_notEqual_ulps()
{
	typedef glm::vec<4, T, glm::defaultp> vec4;
