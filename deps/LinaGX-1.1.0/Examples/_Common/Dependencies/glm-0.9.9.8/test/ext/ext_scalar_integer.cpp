...
namespace isPowerOfTwo
{
	...
	int test_int16()
	{
		type<glm::int16> const Data[] = {{0x0001, true}, {0x0002, true}, {0x0004, true}, {0x0080, true}, {0x0000, true}, {0x0003, false}};
	...
	int test_uint16()
	{
		type<glm::uint16> const Data[] = {{0x0001, true}, {0x0002, true}, {0x0004, true}, {0x0000, true}, {0x0000, true}, {0x0003, false}};
	...
	int test_int32()
	{
		type<int> const Data[] = {{0x00000001, true}, {0x00000002, true}, {0x00000004, true}, {0x0000000f, false}, {0x00000000, true}, {0x00000003, false}};
	...
	int test_uint32()
	{
		type<glm::uint> const Data[] = {{0x00000001, true}, {0x00000002, true}, {0x00000004, true}, {0x80000000, true}, {0x00000000, true}, {0x00000003, false}};
...
namespace nextPowerOfTwo_advanced
{
	...
	template <typename genType> GLM_FUNC_QUALIFIER genType nextPowerOfTwo_loop(genType value)
	{
	...
	int test_uint32()
	{
		type<glm::uint32> const Data[] = {{0x00000001, 0x00000001},
										  {0x00000002, 0x00000002},
										  {0x00000004, 0x00000004},
										  {0x00000007, 0x00000008},
...
{
	template <typename genIUType> struct type
	{
		genIUType Source;
		genIUType Multiple;
		genIUType Return;
...
namespace nextMultiple
{
	...
	template <typename T> GLM_FUNC_QUALIFIER T nextMultipleMod(T Source, T Multiple)
	{
	...
	template <typename T> GLM_FUNC_QUALIFIER T nextMultipleNeg(T Source, T Multiple)
	{
	...
	template <typename T> GLM_FUNC_QUALIFIER T nextMultipleUFloat(T Source, T Multiple)
	{
	...
	template <typename T> GLM_FUNC_QUALIFIER T nextMultipleFloat(T Source, T Multiple)
	{
	...
	template <typename T> int test_uint()
	{
		type<T> const Data[] = {{3, 4, 4}, {6, 3, 6}, {5, 3, 6}, {7, 7, 7}, {0, 1, 0}, {8, 3, 9}};
...
namespace findNSB
{
	...
	template <typename T> int run()
	{
		type<T> const Data[] = {{0x00, 1, -1}, {0x01, 2, -1}, {0x02, 2, -1}, {0x06, 3, -1}, {0x01, 1, 0}, {0x03, 1, 0}, {0x03, 2, 1}, {0x07, 2, 1}, {0x05, 2, 2}, {0x0D, 2, 2}};
