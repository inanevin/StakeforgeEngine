...
template <typename vecType> static int test_min()
{
...
template <typename vecType> static int test_min_nan()
{
	typedef typename vecType::value_type T;
...
template <typename vecType> static int test_max()
{
	typedef typename vecType::value_type T;
...
template <typename vecType> static int test_max_nan()
{
	typedef typename vecType::value_type T;
...
template <typename vecType> static int test_fmin()
{
	typedef typename vecType::value_type T;
...
template <typename vecType> static int test_fmax()
{
	typedef typename vecType::value_type T;
