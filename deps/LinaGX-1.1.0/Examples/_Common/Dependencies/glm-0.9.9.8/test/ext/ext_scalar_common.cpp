...
template <typename T> static int test_min()
{
	int Error = 0;
...
template <typename T> static int test_min_nan()
{
	int Error = 0;
...
template <typename T> static int test_max()
{
	int Error = 0;
...
template <typename T> static int test_max_nan()
{
	int Error = 0;
...
template <typename T> static int test_fmin()
{
	int Error = 0;
...
template <typename T> static int test_fmax()
{
	int Error = 0;
