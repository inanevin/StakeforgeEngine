...
namespace spirv_cross
{
	...
	template <typename T> struct sampler2DBase : spirv_cross_sampler_2d
	{
	...
	template <typename T> inline T texture(const sampler2DBase<T>& samp, const glm::vec2& uv, float bias = 0.0f)
	{
