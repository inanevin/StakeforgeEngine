...
namespace SPIRV_CROSS_NAMESPACE
{
	...
	{
	public:
		explicit CompilerCPP(std::vector<uint32_t> spirv_) : CompilerGLSL(std::move(spirv_))
		{
		}

		CompilerCPP(const uint32_t* ir_, size_t word_count) : CompilerGLSL(ir_, word_count)
		{
		}
