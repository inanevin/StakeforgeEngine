...
{
	template <typename genType> struct type
	{
		genType Base;
		genType Insert;
		int		Offset;
	...
	typeU32 const Data32[] = {{0x00000000, 0xffffffff, 0, 32, 0xffffffff},
...
namespace bitfieldReverse
{
	...
	*/
	template <glm::length_t L, typename T, glm::qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> bitfieldReverseLoop(glm::vec<L, T, Q> const& v)
	{
	...
	template <typename T> GLM_FUNC_QUALIFIER T bitfieldReverseLoop(T v)
	{
	...
	template <bool EXEC = false> struct compute_bitfieldReverseStep
	{
		template <glm::length_t L, typename T, glm::qualifier Q> GLM_FUNC_QUALIFIER static glm::vec<L, T, Q> call(glm::vec<L, T, Q> const& v, T, T)
		{
			return v;
		}
	};

	template <> struct compute_bitfieldReverseStep<true>
	{
		template <glm::length_t L, typename T, glm::qualifier Q> GLM_FUNC_QUALIFIER static glm::vec<L, T, Q> call(glm::vec<L, T, Q> const& v, T Mask, T Shift)
		{
			return (v & Mask) << Shift | (v & (~Mask)) >> Shift;
		}
	};

	template <glm::length_t L, typename T, glm::qualifier Q> GLM_FUNC_QUALIFIER glm::vec<L, T, Q> bitfieldReverseOps(glm::vec<L, T, Q> const& v)
	{
		glm::vec<L, T, Q> x(v);
	...
	template <typename genType> GLM_FUNC_QUALIFIER genType bitfieldReverseOps(genType x)
	{
	...
	typeU32 const Data32[] = {
		{0x00000001, 0x80000000, SUCCESS}, {0x0000000f, 0xf0000000, SUCCESS}, {0x000000ff, 0xff000000, SUCCESS}, {0xf0000000, 0x0000000f, SUCCESS}, {0xff000000, 0x000000ff, SUCCESS}, {0xffffffff, 0xffffffff, SUCCESS}, {0x00000000, 0x00000000, SUCCESS}};
...
namespace findMSB
{
	template <typename genType, typename retType> struct type
	{
		genType Value;
		retType Return;
	};
	...
	template <typename genIUType> static int findMSB_intrinsic(genIUType Value)
	{
	...
	template <typename genIUType> static int findMSB_avx(genIUType Value)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genIUType>::is_integer, "'findMSB' only accept integer values");
	...
	template <typename genIUType> static int findMSB_095(genIUType Value)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genIUType>::is_integer, "'findMSB' only accept integer values");
	...
	template <typename genIUType> static int findMSB_nlz1(genIUType x)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genIUType>::is_integer, "'findMSB' only accept integer values");
	...
	{
		type<int, int> const Data[] = {{0x00000000, -1}, {0x00000001, 0},  {0x00000002, 1},	 {0x00000003, 1},  {0x00000004, 2},	 {0x00000005, 2},  {0x00000007, 2},	 {0x00000008, 3},  {0x00000010, 4},	 {0x00000020, 5},  {0x00000040, 6},	 {0x00000080, 7},
									   {0x00000100, 8},	 {0x00000200, 9},  {0x00000400, 10}, {0x00000800, 11}, {0x00001000, 12}, {0x00002000, 13}, {0x00004000, 14}, {0x00008000, 15}, {0x00010000, 16}, {0x00020000, 17}, {0x00040000, 18}, {0x00080000, 19},
									   {0x00100000, 20}, {0x00200000, 21}, {0x00400000, 22}, {0x00800000, 23}, {0x01000000, 24}, {0x02000000, 25}, {0x04000000, 26}, {0x08000000, 27}, {0x10000000, 28}, {0x20000000, 29}, {0x40000000, 30}};
	...
	static int test_ivec4()
	{
		type<glm::ivec4, glm::ivec4> const Data[] = {
			{glm::ivec4(0x00000000), glm::ivec4(-1)}, {glm::ivec4(0x00000001), glm::ivec4(0)},	{glm::ivec4(0x00000002), glm::ivec4(1)},  {glm::ivec4(0x00000003), glm::ivec4(1)},	{glm::ivec4(0x00000004), glm::ivec4(2)},
			{glm::ivec4(0x00000005), glm::ivec4(2)},  {glm::ivec4(0x00000007), glm::ivec4(2)},	{glm::ivec4(0x00000008), glm::ivec4(3)},  {glm::ivec4(0x00000010), glm::ivec4(4)},	{glm::ivec4(0x00000020), glm::ivec4(5)},
			{glm::ivec4(0x00000040), glm::ivec4(6)},  {glm::ivec4(0x00000080), glm::ivec4(7)},	{glm::ivec4(0x00000100), glm::ivec4(8)},  {glm::ivec4(0x00000200), glm::ivec4(9)},	{glm::ivec4(0x00000400), glm::ivec4(10)},
			{glm::ivec4(0x00000800), glm::ivec4(11)}, {glm::ivec4(0x00001000), glm::ivec4(12)}, {glm::ivec4(0x00002000), glm::ivec4(13)}, {glm::ivec4(0x00004000), glm::ivec4(14)}, {glm::ivec4(0x00008000), glm::ivec4(15)},
			{glm::ivec4(0x00010000), glm::ivec4(16)}, {glm::ivec4(0x00020000), glm::ivec4(17)}, {glm::ivec4(0x00040000), glm::ivec4(18)}, {glm::ivec4(0x00080000), glm::ivec4(19)}, {glm::ivec4(0x00100000), glm::ivec4(20)},
			{glm::ivec4(0x00200000), glm::ivec4(21)}, {glm::ivec4(0x00400000), glm::ivec4(22)}, {glm::ivec4(0x00800000), glm::ivec4(23)}, {glm::ivec4(0x01000000), glm::ivec4(24)}, {glm::ivec4(0x02000000), glm::ivec4(25)},
			{glm::ivec4(0x04000000), glm::ivec4(26)}, {glm::ivec4(0x08000000), glm::ivec4(27)}, {glm::ivec4(0x10000000), glm::ivec4(28)}, {glm::ivec4(0x20000000), glm::ivec4(29)}, {glm::ivec4(0x40000000), glm::ivec4(30)}};
	...
	static int test_int()
	{
		...
		entry const Data[] = {{0x00000000, -1}, {0x00000001, 0},  {0x00000002, 1},	{0x00000003, 1},  {0x00000004, 2},	{0x00000005, 2},  {0x00000007, 2},	{0x00000008, 3},  {0x00000010, 4},	{0x00000020, 5},  {0x00000040, 6},	{0x00000080, 7},
							  {0x00000100, 8},	{0x00000200, 9},  {0x00000400, 10}, {0x00000800, 11}, {0x00001000, 12}, {0x00002000, 13}, {0x00004000, 14}, {0x00008000, 15}, {0x00010000, 16}, {0x00020000, 17}, {0x00040000, 18}, {0x00080000, 19},
							  {0x00100000, 20}, {0x00200000, 21}, {0x00400000, 22}, {0x00800000, 23}, {0x01000000, 24}, {0x02000000, 25}, {0x04000000, 26}, {0x08000000, 27}, {0x10000000, 28}, {0x20000000, 29}, {0x40000000, 30}};
...
namespace findLSB
{
...
#if GLM_HAS_BITSCAN_WINDOWS
	template <typename genIUType> static int findLSB_intrinsic(genIUType Value)
	{
	...
	template <typename genIUType> static int findLSB_095(genIUType Value)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genIUType>::is_integer, "'findLSB' only accept integer values");
		if (Value == 0) return -1;
	...
	template <typename genIUType> static int findLSB_ntz2(genIUType x)
	{
		if (x == 0) return -1;
	...
	template <typename genIUType> static int findLSB_branchfree(genIUType x)
	{
		bool	  IsNull(x == 0);
...
namespace bitCount
{
	...
	template <typename T> inline int bitCount_if(T v)
	{
	...
	template <typename T> inline int bitCount_vec(T v)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<T>::is_integer, "'bitCount' only accept integer values");
	...
	template <bool EXEC = false> struct compute_bitfieldBitCountStep
	{
		template <glm::length_t L, typename T, glm::qualifier Q> GLM_FUNC_QUALIFIER static glm::vec<L, T, Q> call(glm::vec<L, T, Q> const& v, T, T)
		{
			return v;
	...
	template <> struct compute_bitfieldBitCountStep<true>
	{
		template <glm::length_t L, typename T, glm::qualifier Q> GLM_FUNC_QUALIFIER static glm::vec<L, T, Q> call(glm::vec<L, T, Q> const& v, T Mask, T Shift)
		{
	...
	template <glm::length_t L, typename T, glm::qualifier Q> static glm::vec<L, int, Q> bitCount_bitfield(glm::vec<L, T, Q> const& v)
	{
	...
	template <typename genType> static int bitCount_bitfield(genType x)
	{
