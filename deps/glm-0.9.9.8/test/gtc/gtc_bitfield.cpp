...
namespace mask
{
	...
	int test_uint()
	{
		type<glm::uint> const Data[] = {{0, 0x00000000}, {1, 0x00000001}, {2, 0x00000003}, {3, 0x00000007}, {31, 0x7fffffff}, {32, 0xffffffff}};
	...
	int test_uvec4()
	{
		type<glm::ivec4> const Data[] = {
			{glm::ivec4(0), glm::ivec4(0x00000000)}, {glm::ivec4(1), glm::ivec4(0x00000001)}, {glm::ivec4(2), glm::ivec4(0x00000003)}, {glm::ivec4(3), glm::ivec4(0x00000007)}, {glm::ivec4(31), glm::ivec4(0x7fffffff)}, {glm::ivec4(32), glm::ivec4(0xffffffff)}};
...
{
	template <typename PARAM, typename RET> inline RET refBitfieldInterleave(PARAM x, PARAM y, PARAM z)
	{
		RET Result = 0;
...
{
	template <typename PARAM, typename RET> inline RET loopBitfieldInterleave(PARAM x, PARAM y, PARAM z, PARAM w)
	{
...
namespace bitfieldInterleave5
{
	...
	GLM_FUNC_QUALIFIER glm::u8vec4 bitfieldDeinterleave_u8vec4(glm::uint32 InterleavedBitfield)
	{
		...
		return glm::u8vec4((Result >> 0) & 0x000000000000FFFFull, (Result >> 16) & 0x00000000FFFF0000ull, (Result >> 32) & 0x0000FFFF00000000ull, (Result >> 48) & 0xFFFF000000000000ull);
	}
