...
template <typename Item, typename Ratio> void invoke_inner(fmt::string_view formatstring, const Item item)
{
...
template <typename Item> void invoke_outer(const uint8_t* Data, size_t Size, const int scaling)
{
