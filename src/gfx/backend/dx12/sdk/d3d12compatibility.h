...
#define __ID3D12CompatibilityDevice_INTERFACE_DEFINED__
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE CreateSharedResource(_In_ const D3D12_HEAP_PROPERTIES*	pHeapProperties,
		...
		virtual HRESULT STDMETHODCALLTYPE CreateSharedHeap(_In_ const D3D12_HEAP_DESC* pHeapDesc, D3D12_COMPATIBILITY_SHARED_FLAGS CompatibilityFlags, REFIID riid, _COM_Outptr_opt_ void** ppHeap) = 0;

		virtual HRESULT STDMETHODCALLTYPE ReflectSharedProperties(_In_ ID3D12Object * pHeapOrResource, D3D12_REFLECT_SHARED_PROPERTY ReflectType, _Out_writes_bytes_(DataSize) void* pData, UINT DataSize) = 0;
	};
	...
	typedef struct ID3D12CompatibilityDeviceVtbl
	{
		...
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(ID3D12CompatibilityDevice* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(ID3D12CompatibilityDevice* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(ID3D12CompatibilityDevice* This);
		...
		HRESULT(STDMETHODCALLTYPE* CreateSharedHeap)(ID3D12CompatibilityDevice* This, _In_ const D3D12_HEAP_DESC* pHeapDesc, D3D12_COMPATIBILITY_SHARED_FLAGS CompatibilityFlags, REFIID riid, _COM_Outptr_opt_ void** ppHeap);

		DECLSPEC_XFGVIRT(ID3D12CompatibilityDevice, ReflectSharedProperties)
		HRESULT(STDMETHODCALLTYPE* ReflectSharedProperties)(ID3D12CompatibilityDevice* This, _In_ ID3D12Object* pHeapOrResource, D3D12_REFLECT_SHARED_PROPERTY ReflectType, _Out_writes_bytes_(DataSize) void* pData, UINT DataSize);
...
#define __D3D11On12CreatorID_INTERFACE_DEFINED__
	...
	D3D11On12CreatorID : public IUnknown{public : };
	...
	typedef struct D3D11On12CreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(D3D11On12CreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(D3D11On12CreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(D3D11On12CreatorID* This);
...
#define __D3D9On12CreatorID_INTERFACE_DEFINED__
	...
	D3D9On12CreatorID : public IUnknown{public : };
	...
	typedef struct D3D9On12CreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(D3D9On12CreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(D3D9On12CreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(D3D9On12CreatorID* This);
...
#define __OpenGLOn12CreatorID_INTERFACE_DEFINED__
	...
	OpenGLOn12CreatorID : public IUnknown{public : };
	...
	typedef struct OpenGLOn12CreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(OpenGLOn12CreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(OpenGLOn12CreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(OpenGLOn12CreatorID* This);
...
#define __OpenCLOn12CreatorID_INTERFACE_DEFINED__
	...
	OpenCLOn12CreatorID : public IUnknown{public : };
	...
	typedef struct OpenCLOn12CreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(OpenCLOn12CreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(OpenCLOn12CreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(OpenCLOn12CreatorID* This);
...
#define __DirectMLTensorFlowCreatorID_INTERFACE_DEFINED__
	...
	DirectMLTensorFlowCreatorID : public IUnknown{public : };
	...
	typedef struct DirectMLTensorFlowCreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(DirectMLTensorFlowCreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(DirectMLTensorFlowCreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(DirectMLTensorFlowCreatorID* This);
...
#define __DirectMLPyTorchCreatorID_INTERFACE_DEFINED__
	...
	DirectMLPyTorchCreatorID : public IUnknown{public : };
	...
	typedef struct DirectMLPyTorchCreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(DirectMLPyTorchCreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(DirectMLPyTorchCreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(DirectMLPyTorchCreatorID* This);
...
#define DirectMLPyTorchCreatorID_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define DirectMLPyTorchCreatorID_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define DirectMLPyTorchCreatorID_Release(This) ((This)->lpVtbl->Release(This))
